...
class OperateReport:
    ...
    def detail(self, worksheet, info):
        ...
        for item in info:
            ...
            if item["result"] == "通过":
                worksheet.write("H" + str(temp), item["result"],
                                get_format(self.wd, {'bold': True, 'font_size': 11, 'align': 'center',
                                                     'valign': 'vcenter', 'bg_color': '#32CD32',
                                                     'font_color': '#ffffff', 'border': 1}))
            else:
                worksheet.write("H" + str(temp), item["result"],
                                get_format(self.wd, {'bold': True, 'font_size': 11, 'align': 'center',
                                                     'valign': 'vcenter', 'bg_color': '#FF4500',
                                                     'font_color': '#ffffff', 'border': 1}))
